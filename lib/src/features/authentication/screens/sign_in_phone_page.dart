...
import 'package:com_akdemix/src/features/authentication/screens/sign_in_phone_model.dart';
...
final emptyCountryWithPhoneCode = CountryWithPhoneCode(
  phoneCode: "",
  countryCode: "",
...
final selectedCountryProvider =
  ...
  return authState.maybeWhen(
    ...
    orElse: () => emptyCountryWithPhoneCode,
  );
});

class SignInPhonePageBuilder extends ConsumerWidget {
  const SignInPhonePageBuilder({super.key});
            ...
            child: Column(children: [
                    ...
                    child: OutlinedButton(
                      onPressed: () {
                        Navigator.of(context)
                            .pushNamed(AppRoutes.countriesPage);
                      },
              ...
              SizedBox(
                ...
                child: CustomButton(
                  text: "Continue",
                  onPressed: () {
                    widget.canSubmit ? widget.onSubmit : null;
                  },
                ),
              ),
